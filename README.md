...
A no-build browser game for virtual team building. One person draws, teammates guess, and the host runs quick timed rounds with prompts, a drawing board, guess log, reveal button, and scoreboard.

## Run

Open `index.html` in a browser. No install, build step, server, account, or external API is required.
